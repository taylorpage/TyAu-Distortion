//
//  DistortionExtensionAUProcessHelper.hpp
//  DistortionExtension
//
...
#include <vector>
#include "DistortionExtensionDSPKernel.hpp"
#include "DistortionExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(DistortionExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    DistortionExtensionDSPKernel& mKernel;
